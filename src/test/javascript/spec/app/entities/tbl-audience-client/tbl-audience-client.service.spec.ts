...
describe('Service Tests', () => {
    ...
    describe('TblAudienceClient Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblAudienceClientService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-audience-clients';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblAudienceClient', () => {

                let entity: TblAudienceClient;
                service.find(123).subscribe((_entity: TblAudienceClient) => {
                    entity = _entity;
                });
