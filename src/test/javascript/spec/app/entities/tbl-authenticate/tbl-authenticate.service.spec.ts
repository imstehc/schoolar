...
describe('Service Tests', () => {
    ...
    describe('TblAuthenticate Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblAuthenticateService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-authenticates';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblAuthenticate', () => {

                let entity: TblAuthenticate;
                service.find(123).subscribe((_entity: TblAuthenticate) => {
                    entity = _entity;
                });
