...
describe('Service Tests', () => {
    ...
    describe('TblAuthentication Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblAuthenticationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-authentications';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblAuthentication', () => {

                let entity: TblAuthentication;
                service.find(123).subscribe((_entity: TblAuthentication) => {
                    entity = _entity;
                });
