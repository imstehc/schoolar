...
describe('Service Tests', () => {
    ...
    describe('TblClassCoordinator Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblClassCoordinatorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-class-coordinators';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblClassCoordinator', () => {

                let entity: TblClassCoordinator;
                service.find(123).subscribe((_entity: TblClassCoordinator) => {
                    entity = _entity;
                });
