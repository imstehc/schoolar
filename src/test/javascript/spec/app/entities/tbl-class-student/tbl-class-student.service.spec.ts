...
describe('Service Tests', () => {
    ...
    describe('TblClassStudent Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblClassStudentService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-class-students';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblClassStudent', () => {

                let entity: TblClassStudent;
                service.find(123).subscribe((_entity: TblClassStudent) => {
                    entity = _entity;
                });
