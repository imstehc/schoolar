...
describe('Service Tests', () => {
    ...
    describe('TblClass Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblClassService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-classes';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblClass', () => {

                let entity: TblClass;
                service.find(123).subscribe((_entity: TblClass) => {
                    entity = _entity;
                });
