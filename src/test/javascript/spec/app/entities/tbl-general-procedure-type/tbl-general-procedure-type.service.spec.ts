...
describe('Service Tests', () => {
    ...
    describe('TblGeneralProcedureType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblGeneralProcedureTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-general-procedure-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblGeneralProcedureType', () => {

                let entity: TblGeneralProcedureType;
                service.find(123).subscribe((_entity: TblGeneralProcedureType) => {
                    entity = _entity;
                });
