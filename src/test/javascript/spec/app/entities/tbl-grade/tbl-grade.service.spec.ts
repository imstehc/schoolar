...
describe('Service Tests', () => {
    ...
    describe('TblGrade Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblGradeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-grades';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblGrade', () => {

                let entity: TblGrade;
                service.find(123).subscribe((_entity: TblGrade) => {
                    entity = _entity;
                });
