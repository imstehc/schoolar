...
describe('Service Tests', () => {
    ...
    describe('TblGuardianHistory Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblGuardianHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-guardian-histories';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblGuardianHistory', () => {

                let entity: TblGuardianHistory;
                service.find(123).subscribe((_entity: TblGuardianHistory) => {
                    entity = _entity;
                });
