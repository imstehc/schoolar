...
describe('Service Tests', () => {
    ...
    describe('TblGuardianType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblGuardianTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-guardian-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblGuardianType', () => {

                let entity: TblGuardianType;
                service.find(123).subscribe((_entity: TblGuardianType) => {
                    entity = _entity;
                });
