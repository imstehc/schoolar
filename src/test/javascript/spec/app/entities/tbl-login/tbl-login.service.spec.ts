...
describe('Service Tests', () => {
    ...
    describe('TblLogin Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblLoginService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-logins';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblLogin', () => {

                let entity: TblLogin;
                service.find(123).subscribe((_entity: TblLogin) => {
                    entity = _entity;
                });
