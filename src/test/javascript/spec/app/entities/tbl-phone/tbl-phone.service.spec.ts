...
describe('Service Tests', () => {
    ...
    describe('TblPhone Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblPhoneService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-phones';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblPhone', () => {

                let entity: TblPhone;
                service.find(123).subscribe((_entity: TblPhone) => {
                    entity = _entity;
                });
