...
describe('Service Tests', () => {
    ...
    describe('TblSchoolNetworkSchool Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblSchoolNetworkSchoolService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-school-network-schools';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblSchoolNetworkSchool', () => {

                let entity: TblSchoolNetworkSchool;
                service.find(123).subscribe((_entity: TblSchoolNetworkSchool) => {
                    entity = _entity;
                });
