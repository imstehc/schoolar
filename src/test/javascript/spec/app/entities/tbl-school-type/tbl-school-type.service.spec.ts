...
describe('Service Tests', () => {
    ...
    describe('TblSchoolType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TblSchoolTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tbl-school-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TblSchoolType', () => {

                let entity: TblSchoolType;
                service.find(123).subscribe((_entity: TblSchoolType) => {
                    entity = _entity;
                });
